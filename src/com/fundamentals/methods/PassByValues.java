...
public class PassByValues {
	...
	public static void main(String[] args) {
		...
		array = increaseArraySizeBy1(array);
		System.out.println("array after increaseArraySizeBy1():\t" + Arrays.toString(array));
	}
	...
	private static void clearArray(int[] array) {
		array = null;
		System.out.println("array in clearArray():\t" + array);
	}
	
	private static int[] increaseArraySizeBy1(int[] array) {
